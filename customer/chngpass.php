...
<form action="chngpass.php" method="post">
  <div class="container">
    ...
    <input type="password" placeholder="" name="opsw" required>

    <label for="npsw"><b>New Password</b></label>
    <input type="password" placeholder="" name="npsw" required>
    
    <label for="cpsw"><b>Confirm Password</b></label>
    <input type="password" placeholder="" name="cpsw" required>
...
if(isset($_POST['submit']))
{
	...
	if($npsw==$cpsw)
	{
		$sql="select pass from customer where pass='$opsw' and uname='$uname'";
		$r=mysqli_query($con,$sql);
		if(mysqli_num_rows($r)>0)
			{
				$sql1="update customer set pass='$npsw' where uname='$uname'";
